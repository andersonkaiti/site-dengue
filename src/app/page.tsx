      ...
      <main className="flex min-h-screen flex-col items-center justify-between pt-24">
        <section className={styles.contentPair} data-aos="fade-left" data-aos-once="true">
          ...
          <div className="content">
            <h2 className="title">A Dengue Não Escolhe Vítimas, Escolha Prevenir!</h2>
            <p>
        ...
        <section className={`${styles.contentPair} content`} data-aos="fade-right" data-aos-once="true">
          <div className={styles.dengueAttacksContent}>
            <h2 className="title">Como a Dengue ataca o corpo?</h2>
            <p>
        ...
        {/* <section className={styles.emphasis}>
          <h2 className={styles.emphasisTitle}>Prevenção</h2>
        ...
        <section className="content" data-aos="fade-left" data-aos-once="true">
          <h2 className="title">Sintomas</h2>
          <p>
        ...
        <section className={`${styles.contentPair} content`} data-aos="fade-right" data-aos-once="true">
          <div className={styles.contentPairText}>
            <h2 className="title">Crianças e Idosos</h2>
            <p>
        ...
        <section className="content" data-aos="fade-left" data-aos-once="true">
          <h2 className="title">Casos de Dengue em Ascensão: Um Perigo Subestimado</h2>
          <p>
        ...
        <section className="content" data-aos="fade-right" data-aos-once="true">
          <h2 className="title">Proteja-se e Ajude a Reduzir os Casos</h2>
          <p>
        ...
        <section className="content" data-aos="fade-left" data-aos-once="true">
          <h2 className="title">Juntos Somos Mais Fortes!</h2>
          <p>
        ...
        <section className={`${styles.contentPair} content`} data-aos="fade-right" data-aos-once="true">
          ...
          <div className={styles.contentPairText}>
            <h2 className="title">Cuidados Importantes</h2>
            <p>
