    ...
    return (
        <>
            <main>
                ...
                <section className={styles.section}>
                    <h1 className="title-two">&quot;Alerta Dengue: Mantenha-se Informado, <span> Proteja-se e Faça a Diferença!</span>&quot;</h1>
                    <div className={styles.gallery}>
                        <div className={styles.galleryImage}>
                            <Image
                ...
                <section className={styles.section}>
                    <h1 className="title-two">Eventos e Iniciativas</h1>
                ...
                <section className={styles.section}>
                    <h1 className="title-two">Alertas e Informações sobre a Dengue</h1>
                    <div className={styles.gallery}>
                        <div className={styles.galleryImage}>
                            <Image
                ...
                <section className={styles.section}>
                    <h1 className="title-two">Campanhas de conscientização</h1>
                    <div className={styles.text}>
                ...
                <section className={styles.section}>
                    <h1 className="title-two">Novidade de pesquisa</h1>
                    <div className={styles.text}>
