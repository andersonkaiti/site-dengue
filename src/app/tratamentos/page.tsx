        ...
        <>
            <main>
                ...
                <section className={`${styles.identifySymptons} ${styles.content}`}>
                    ...
                    <div className={styles.identifySymptonsImage}>
                        <Image
                            src="/tratamentos/MosquitoTratamentos.jpg"
                            alt="Mosquito"
                            {...ImageAttr}
                ...
                <section className={styles.content}>
                    <h2 className="title-two">Tratamentos de casos leves</h2>
                    <p>
                ...
                <section className={styles.content}>
                    <h2 className="title-two">Medicações Indicadas e Contraindicadas</h2>
                    <p>
                    ...
                    <section className={styles.gallery}>
                        <div className={styles.verticalGallery}>
                            ...
                            <div className={styles.galleryImage}>
                                <Image
                                    src="/tratamentos/MaosDadasTratamentos.png"
                                    alt="Idoso coberto"
                                    {...ImageAttr}
                                />
                            </div>
                ...
                <section className={styles.content}>
                    <h2 className="title-two">Recuperação e Cuidados Pós-Tratamento</h2>
                    <p>
